...
export default function CreatePost() {
  ...
  // setFormData({...formData, content : data[0].content})
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch('https://story-sever.vercel.app/api/post/create', {
        method: 'POST',
        headers: {
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-4 sm:flex-row justify-between'>
          ...
          {/* <TextInput
            ...
            className='flex-1'
            onChange={(e) =>
              setFormData({ ...formData, content: {titleChapter: e.target.value} })
            }
          /> */}
          <TextInput
            type='text'
          ...
          >
            <option value='uncategorized'>Chọn 1 thể loại</option>
